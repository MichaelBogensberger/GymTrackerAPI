...
public class JWTAuthenticationFilter extends UsernamePasswordAuthenticationFilter {
    ...
    public static final long EXPIRATION_TIME = 999999999; // 1 days
    ...
    public Authentication attemptAuthentication(
        ...
        try {
            ...
            com.gymtracker.gymtracker.model.User loginUser =
                    new ObjectMapper()
                            .readValue(request.getInputStream(), com.gymtracker.gymtracker.model.User.class);
